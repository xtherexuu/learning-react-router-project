...
import VansDetailspage from "./features/Vans/VansDetailspage";
...
import HostIncome, {loader as hostIncomeLoader} from "./features/Host/HostIncome";
...
import HostVansDetailspage, {loader as hostVansDetailspageLoader} from "./features/Host/HostVans/HostVansDetailspage";
  ...
  createRoutesFromElements(
    <Route path="/" element={<Layout />}>
      ...
      <Route path="host" element={<HostLayout />}>
        ...
        <Route path="vans/:id" element={<HostVansDetailspage />} loader={hostVansDetailspageLoader}>
          <Route index element={<HostVansDetailspageDashboard />} />
          <Route path="pricing" element={<HostVansDetailspagePricing />} />
          <Route path="photos" element={<HostVansDetailspagePhotos />} />
        </Route>
        <Route path="reviews" element={<HostReviews />} loader={hostReviewsLoader} />
      </Route>
